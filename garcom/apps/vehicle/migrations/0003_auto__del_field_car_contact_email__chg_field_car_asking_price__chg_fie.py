...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Car.contact_email'
        db.delete_column('vehicle_car', 'contact_email')


        # Changing field 'Car.asking_price'
        db.alter_column('vehicle_car', 'asking_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3))

        # Changing field 'Image.image'
        db.alter_column('vehicle_image', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'Car.contact_email'
        db.add_column('vehicle_car', 'contact_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


        # Changing field 'Car.asking_price'
        db.alter_column('vehicle_car', 'asking_price', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'Image.image'
        db.alter_column('vehicle_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'vehicle.car': {
            ...
            'asking_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '3', 'blank': 'True'}),
